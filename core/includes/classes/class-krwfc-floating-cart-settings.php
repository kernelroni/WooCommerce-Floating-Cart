 ...
 * 
 * KRWFC->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */
 ...
 *
 * @package		KRWFC
 * @subpackage	Classes/Woocommerce_Floating_Cart_Settings
 * @author		Roni Das
 * @since		1.0.0
 */
class krwfc_Floating_Cart_Settings{
	...
	/**
	 * Our Woocommerce_Floating_Cart_Settings constructor 
	...
	public function get_plugin_name(){
		return apply_filters( 'KRWFC/settings/get_plugin_name', $this->plugin_name );
	}
}
